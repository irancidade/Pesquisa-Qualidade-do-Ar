...
# Usaremos os primeiros 10 conjuntos como entrada para prever o 11º, e assim por diante
X_provided = np.array([
...
model.fit(X_provided_normalized, y_target_normalized, epochs=100, batch_size=4)
...
# Para prever o 14º, utilizamos os últimos 9 conjuntos e a previsão do 13º conjunto como entrada
